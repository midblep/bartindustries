<main class="@container container flex flex-col gap-20 relative">
	...
	<section class="w-full h-full flex flex-col px-5 justify-between gap-10 lg:gap-20">
		...
		<article class="grid grid-cols-1 @6xl:grid-cols-4 gap-5 relative">
			...
			<div class="object-cover @6xl:aspect-[2/1] h-full w-full @6xl:col-span-2 lg:p-10 flex flex-col gap-5 text-lg">
				<p>
